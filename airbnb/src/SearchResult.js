...
import {FaRupeeSign, FaParking,FaDollarSign} from "react-icons/fa"
           ...
           <div className="searchResult_info">
               ...
               <div className="searchResult_infoBottom">
                    ...
                    <div className="searchResult_price">
                        <h3><FaDollarSign />{total}/ night + gst  <FaDollarSign /> {total*0.01*18}</h3>
                        <p style={{fontSize:"15px",color:"rgb(113, 113, 113)",textDecoration:"underline"}}><FaDollarSign style={{fontSize:"15px !important" }} /> {price+price*0.01*18} total </p>
                    </div>
               </div>
           </div>
         </div>
